...
#ifndef DBCStructureH
#define DBCStructureH
//---------------------------------------------------------------------------
#include "CommFunc.h"
...
struct BarberShopStyleEntry
{
    ...
    //uint32  name_flags;                                   // 18
    char*  unk_name[16];                                 // 19-34, all empty
    //uint32  unk_flags;                                    // 35
...
struct MapEntry
{
	...
	int32   ghost_entrance_map;                                   // 59 map_id of entrance map
	float   ghost_entrance_x;                                     // 60 entrance x coordinate (if exist single entry)
    float   ghost_entrance_y;                                     // 61 entrance y coordinate (if exist single entry)
